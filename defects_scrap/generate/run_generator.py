...
Usage (from repo root):
    python -m modules.defects_scrap.generate.run_generator

Output structure:
    modules/defects_scrap/data/raw/
    ...
    modules/defects_scrap/data/samples/
...
def run() -> None:
    ...
    print()
    print("Next steps:")
    print("  git add modules/m01_quality_scrap/data/samples/")
